                ...
                <div class="container">
                    <div class="compare-table table-responsive">
                        <table class="table table-bordered table-hover mb-0">
                            <tbody v-for="(list,index) in listCompare" :key="index" >
                                <tr >
                                ...
                                <tr>
                                    <th>Product Name</th>
                                    <td>
                                        <h5 class="compare-product-name"><a href="single-product.html">{{list.system}}</a></h5>
                                    </td>
                                    <td>
    ...
    methods:{
        viewCompare(){
            if(localStorage.getItem('compare')){
                this.listCompare =JSON.parse(localStorage.getItem('compare'));
            }
        }
