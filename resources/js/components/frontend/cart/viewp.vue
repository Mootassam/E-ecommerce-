                        ...
                        <div class="col-lg-5 col-md-6">
                           <!-- Product Details Left -->
                            <div class="product-details-left">
                                ...
                                <div class="product-details-thumbs slider-thumbs-1" v-for=" pic in images" :key="pic.id">
                                    <div class="sm-image">
                      <img v-bind:src="'products/small/'+pic.image" alt="" class="img-fluid">
                      </div>
                            ...
                            <div class="product-details-view-content pt-60">
                                <div class="product-info">
                                    ...
                                    <div class="price-box pt-20">
                                        <span class="new-price new-price-2">{{product.price }} TND</span>
                                    </div>
...
export default {
    ...
    data() {
        return {
            ...
            relateProducts:this.data.relateProducts,
